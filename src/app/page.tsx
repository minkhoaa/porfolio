    ...
    <>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div className="text-center mt-14">
          <Link href="/projects" className="inline-block border-2 border-retro-amber px-10 py-3.5 font-pixel text-[11px] text-retro-amber bg-retro-amber/5 hover:bg-retro-amber/15 transition-all duration-300 hover:shadow-[0_0_30px_rgba(167,139,250,0.15)]">
            VIEW QUEST LOG
          </Link>
        </div>
      </section>
