  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative px-4">
      <div className="max-w-3xl w-full">
        <p className="font-pixel text-[10px] text-retro-amber/60 tracking-[0.3em] mb-4">
          CLASS: {profile.role.toUpperCase()}
        </p>

        <GlitchText text={profile.name} as="h1" className="font-pixel text-4xl sm:text-5xl md:text-6xl text-retro-tan leading-relaxed" />
        ...
        <div className="mt-12 flex flex-col sm:flex-row gap-4">
          <Link href="/projects" className="border-2 border-retro-amber px-8 py-3.5 font-pixel text-[11px] text-retro-amber bg-retro-amber/5 hover:bg-retro-amber/15 transition-all hover:shadow-[0_0_25px_rgba(167,139,250,0.2)] text-center">
            QUEST LOG
          </Link>
          <Link href="/about" className="border-2 border-retro-brown px-8 py-3.5 font-pixel text-[11px] text-retro-muted hover:text-retro-amber hover:border-retro-amber transition-all text-center">
            CHARACTER SHEET
          </Link>
        </div>
      </div>
